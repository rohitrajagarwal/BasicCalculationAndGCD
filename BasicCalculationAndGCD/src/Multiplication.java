public class Multiplication extends Calculate{
    ...
    // implementing Calculate.calculate() method to perform multiplication operation
    @Override
    public void calculate(Integer num1, Integer num2) {
        this.setResult(num1 * num2);
    }

    // implementing Calculate.printResult() method to print the output in appropriate format based on multiplication operation
    public void printResult(Object num1, Object num2) {
        System.out.println("Multiplication : "+ num1.toString()+ " * "+ num2.toString() + " = " + getResult().toString());
    }
}
